...
main(){
	...
	cout<<"ENTER THE NO. YOU WANT TO CHOOSE\n";
...
void intersection(){
	...
	cin>>x;
	cout<<"Enter the elements in a Set A:\n";
	for(int i=0;i<x;i++){
		cin>>a[i];
	}
	cout<<"Number of Elements in Set B: ";
	cin>>y;
	cout<<"Enter the elements in a Set B:\n";
	for(int i=0;i<y;i++){
		cin>>b[i];
	}
	for(int i=0;i<x;i++){
...
void unio(){
	...
	cout<<"Number of Elements in Set A: ";
	cin>>x;
	cout<<"Enter the element in a Set A:\n";
	for(int i=0;i<x;i++){
		cin>>a[i];
	}
	cout<<"Number of Elements in Set B: ";
	cin>>y;
	cout<<"Enter the element in a Set B:\n";
	for(int i=0;i<y;i++){
		cin>>b[i];	
...
void complement(){
	...
	int x,y,z,count=0;
	cout<<"Complement. The set of elements that are in the universal that do not belong to a given set.\n";
	cout<<"Number of Elements in Universal Set: ";
	cin>>x;
	cout<<"Enter the element in a Universal Set:\n";
	for(int i=0;i<x;i++){
		cin>>u[i];
	}
	cout<<"Number of Elements in Set A: ";
...
void relative(){
	int a[100],b[100],temp[100];
	int x,y,z,count=0;
	cout<<"Difference or Relative Complement: The set of elements that belong to a set but not to another or the \ndifference of sets A and B, denoted by A/B (or A-B) is the set containing those elements that are in A \nbut not in B. or vice versa\n\n";
	cout<<"size in Set A: ";
	cin>>x;
	cout<<"Enter the element in a Set A:\n";
	for(int i=0;i<x;i++){
